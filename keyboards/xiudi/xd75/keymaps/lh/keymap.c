...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, LT(0,KC_NUM), LT(0,KC_INS), LT(0,KC_DEL), KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL, LALT_T(KC_GRV), KC_Q, KC_W, KC_F, LT(5,KC_P), KC_B, LT(0,KC_P7), LT(0,KC_P8), LT(0,KC_P9), KC_J, LT(4,KC_L), KC_U, KC_Y, KC_SCLN, KC_MINS, KC_TAB, LALT_T(KC_A), LGUI_T(KC_R), LSFT_T(KC_S), LCTL_T(KC_T), LT(6,KC_G), LT(0,KC_P4), LT(0,KC_P5), LT(0,KC_P6), KC_M, RCTL_T(KC_N), RSFT_T(KC_E), RGUI_T(KC_I), RALT_T(KC_O), LT(4,KC_QUOT), KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V, LT(0,KC_P1), LT(0,KC_P2), LT(0,KC_P3), KC_K, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, LSA_T(KC_LEFT), LCA_T(KC_RGHT), LAG_T(KC_MPLY), LT(4,KC_BSPC), LCTL_T(KC_SPC), LGUI_T(KC_ENT), LM(5, MOD_LALT), LT(7,KC_P0), LT(6,KC_PDOT), LT(7,KC_ENT), LT(5,KC_BSPC), RSFT_T(KC_DEL), KC_LBRC, KC_RBRC, KC_ENT),
